...
class FlutterHandTrackingPlugin(r: Registrar, id: Int) : PlatformView, MethodCallHandler {
    companion object {
        ...
        private const val BINARY_GRAPH_NAME = "face_detection_mobile_cpu.binarypb"
        private const val INPUT_VIDEO_STREAM_NAME = "input_video"
        private const val OUTPUT_VIDEO_STREAM_NAME = "output_video"
        private const val OUTPUT_HAND_PRESENCE_STREAM_NAME = "face_detections"
        private const val OUTPUT_LANDMARKS_STREAM_NAME = "face_landmarks"
    ...
    private fun setupProcess() {
        ...
        processor.addPacketCallback(
            ...
            val detections = PacketGetter.getProtoVector(packet, DetectionProto.Detection.parser())
if(detections == null){
Log.d(TAG, "detections null")
}
else{
Log.d(TAG, "detections not null 0: ${detections}")
}
        }
    }
